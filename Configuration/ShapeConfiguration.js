define(["require", "exports", "Classes/Domain/Model/ShapeType", "Classes/Domain/Model/Vector", "Classes/Domain/Model/VariantType", "Classes/Domain/Model/Variant"], function (require, exports, ShapeType, Vector, VariantType, Variant) {
    "use strict";
    var ShapeConfiguration = /** @class */ (function () {
        function ShapeConfiguration() {
        }
        ShapeConfiguration.variantTypes = {
        ...
        ShapeConfiguration.shapeTypes = {
            railStraight: new ShapeType('railStraight', 'Rail straight', [new Vector(63.8, 0.0, 0.0), new Vector(63.8, 0.5, 0.5)], [
            ...
            railStraightHalf: new ShapeType('railStraightHalf', 'Rail straight half', [new Vector(31.9, 0.0, 0.0), new Vector(31.9, 0.5, 0.5)], [
            ...
            railCurved: new ShapeType('railCurved', 'Rail curved', [new Vector(62.3424, 0.9906, 0.96875), new Vector(62.3424, 0.5094, 0.53125)], [
            ...
            railCurvedHalf: new ShapeType('railCurvedHalf', 'Rail curved half', [new Vector(31.27975, 1 - 0.00391, 1 - 0.01563), new Vector(31.27974, 0.5 + 0.00391, 0.5 + 0.01563)], [
            ...
            switchStraightLeft: new ShapeType('switchStraightLeft', 'Switch straight left', [new Vector(131.52707, 0.03899, 0.0), new Vector(131.52707, 0.46101, 0.5), new Vector(131.52707, 0.96101, 0.0)], [
            ...
            switchStraightRight: new ShapeType('switchStraightRight', 'Switch straight right', [new Vector(131.52707, 0.03899, 0.0), new Vector(131.52707, 0.46101, 0.5), new Vector(131.52707, 0.53899, 0.5)], [
            ...
            switchBranchingRight: new ShapeType('switchBranchingRight', 'Switch branching right', [new Vector(145.01793, 0.05493, 0.0), new Vector(128.47218, 0.43763, 0.5), new Vector(134.50488, 0.56253, 0.5 + 0.0625)], [
                new Variant(ShapeConfiguration.variantTypes['S9V'], 272.93159, 161.92824, "Resources/Img/Tracks/switchBranchingRight-9V.png"),
            ]),
            switchBranchingLeft: new ShapeType('switchBranchingLeft', 'Switch branching left', [new Vector(145.01793, 0.44507, 0.5), new Vector(128.47218, 0.06237, 0.0), new Vector(134.50488, 0.93747, 0.9375)], [
                new Variant(ShapeConfiguration.variantTypes['S9V'], 272.93159, 161.92824, "Resources/Img/Tracks/switchBranchingLeft-9V.png"),
            ]),
            doubleTrackDoubleCrossing: new ShapeType('doubleTrackDoubleCrossing', 'Double track crossing', [new Vector(201.75331, 0.05121, 0.0), new Vector(201.75331, 0.5 - 0.05120, 0.5), new Vector(201.75331, 0.5 + 0.05120, 0.5), new Vector(201.755331, 1 - 0.05120, 0.0)], [
                new Variant(ShapeConfiguration.variantTypes['S9V'], 382.8, 191.4, "Resources/Img/Tracks/doubleTrackDoubleCrossing-9v.png")
            ]),
            railCrossing: new ShapeType('railCrossing', 'Crossing', [new Vector(63.8, 0.0, 0.0), new Vector(63.8, 0.5, 0.5), new Vector(63.8, 0.25, 0.25), new Vector(63.8, 0.75, 0.75)], [
            ...
            railCrossingOblique: new ShapeType('railCrossingOblique', 'Crossing oblique', [new Vector(127.6, 1 / 16, 1 / 16), new Vector(127.6, 9 / 16, 9 / 16), new Vector(127.6, 15 / 16, 15 / 16), new Vector(127.6, 7 / 16, 7 / 16)], [
            ...
            railRoadCrossing: new ShapeType('railRoadCrossing', 'Railroad crossing', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.75, 0.75)], [
            ...
            railRoadCrossingDouble: new ShapeType('railRoadCrossingDouble', 'Railroad crossing double track', [new Vector(131.52707, 0.03899, 0.0), new Vector(131.52707, 0.46101, 0.5), new Vector(131.52707, 0.53899, 0.5), new Vector(131.52707, 0.96101, 0.0), new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.75, 0.75)], [
            ...
            roadStraight: new ShapeType('roadStraight', 'Road straight', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5)], [
            ...
            roadCurved: new ShapeType('roadCurved', 'Road curved', [new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.5, 0.5)], [
            ...
            roadTCrossing: new ShapeType('roadTCrossing', 'Road T-crossing', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.25, 0.25)], [
            ...
            roadCrossing: new ShapeType('roadCrossing', 'Road crossing', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.75, 0.75)], [
            ...
            areaSquare: new ShapeType('areaSquare', 'Area Square', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.75, 0.75)], [
            ...
            areaRectangle: new ShapeType('areaRectangle', 'Area Rectangle', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.75, 0.75)], [
            ...
            areaTriangle: new ShapeType('areaTriangle', 'Area Triangle', [new Vector(127.6, 0.25, 0.25), new Vector(127.6, 0.5, 0.5)], [
            ...
            riverStraight: new ShapeType('riverStraight', 'River straight', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5)], [
            ...
            riverCurved: new ShapeType('riverCurved', 'River curved', [new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.75, 0.75)], [
            ...
            riverOutfall: new ShapeType('riverOutfall', 'River outfall', [new Vector(127.6, 0.0, 0.0), new Vector(127.6, 0.5, 0.5), new Vector(127.6, 0.75, 0.75)], [
